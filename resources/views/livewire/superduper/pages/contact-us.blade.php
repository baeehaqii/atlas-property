...
">
    <x-superduper.components.breadcrumb title="Hubungi Kami" />
                            ...
                            <div class="flex items-start py-4 transition-all duration-300 bg-white">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 ml-4 text-gray-600">
                                        Kami siap membantu Anda setiap Senin-Jumat dari jam 9 pagi
                                        hingga 5 sore {{ $siteSettings->timezone ?? 'UTC' }}.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start py-4 transition-all duration-300 bg-white">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 ml-4 text-gray-600">
                                        ...
                                        Setiap Senin-Jumat dari jam 9 pagi hingga 5 sore.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start py-4 transition-all duration-300 bg-white">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 ml-4 text-gray-600">
                                        ...
                                        dan Anda akan menerima balasan dalam waktu 24 jam.
                                    </p>
                                </div>
                            </div>
                        </div>
